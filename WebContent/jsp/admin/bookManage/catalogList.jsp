...
<c:if test="${!empty catalogMessage}">
	...
	<div class="container content" style="width: 1100px;margin-left: 200px; border-radius: 10px;margin-top:40px;padding: 1px 40px 0 40px;">
		<div class="funbtn">
			...
			<a class="btn btn-info" href="jsp/admin/bookManage/catalogAdd.jsp" >新增分类</a>
		</div>
		<table class="table table-striped table-hover">
			<tr class="success" style="border-top: 2px solid black">
				...
				<th style="background-color:#9fc6cd;text-align: center">分类编号</th>
				<th style="background-color:#9fc6cd;text-align: center">分类名称</th>
				<th style="background-color:#9fc6cd;text-align: center">🛠️操  作</th>
			</tr>
			<!---若catalogList不为空，遍历输出其中的信息--->
			<c:choose>
				<c:when test="${!empty catalogList}">
					<c:forEach items="${catalogList}" var="i" >
						<tr style="border-top: 2px solid black">
							<!---勾选的话 返回 checkbox 的 value 属性的值 --->
