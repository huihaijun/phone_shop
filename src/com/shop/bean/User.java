...
public class User {
	...
	public User( String userPassWord, String name, String sex, int age, String tell, String address) {
		super();
	...
	public User(int userId, int credit, String userPassWord, String name, String sex, int age, String tell, String address,
				String enabled) {
		super();
		this.userId = userId;
		this.credit = credit;
	...
	public void setCredit(int userId) {
		this.credit = credit;
	}
