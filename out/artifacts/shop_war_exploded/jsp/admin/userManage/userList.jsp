	...
	<div class="container content"style="width: 1100px;margin-left: 200px; border-radius: 10px;margin-top:40px;padding: 1px 40px 0 40px;">
		...
		<table class="table table-striped table-hover">
			<tr class="success" style="border-top: 2px solid black">
				...
				<th style="background-color:#9fc6cd;text-align: center">信誉分</th>
				...
				<th style="background-color:#9fc6cd;text-align: center">🚥状  态</th>
				...
				<c:when  test="${!empty userList}">
					<c:forEach items="${userList}" var="i" varStatus="n">
						<tr style="border-top: 2px solid black">
							...
							<td>
								<c:choose>
									<c:when test="${i.credit >=70}">
										<span style="background:green;color:#fff">✅${i.credit}</span>
									</c:when>
									<c:otherwise>
										<span style="background:#ff7069;color:#fff">❌${i.credit}</span>
									</c:otherwise>
								</c:choose>
							</td>
							<td>${i.userName}</td>
